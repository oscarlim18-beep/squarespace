...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const groupedAddons = {
    ...
    "Electrical Components": [
      ...
      { name: "Black Fan (Deka) 56/46 inch", price: 285, img: "../image/rustic-fan.png" },
      { name: "White Fan (Deka) 56/46 inch", price: 285, img: "../image/timeless-fan.png" },
      { name: "Lighting 12 Watt, 4000K", price: 15, img: "../image/led.png" },
      { name: "Lighting 18 Watt, 4000K", price: 20, img: "../image/led.png" },
      { name: "Lighting 24 Watt, 4000K", price: 25, img: "../image/led.png" },
      ...
      { name: "Fridge 250L Two Door", price: 1450, img: "../image/fridge.png" },
      { name: "Door Bell", price: 150, img: "../image/doorbell.png" },
      ...
      { name: "Scent Diffuser Set", price: 248, img: "../image/scent.png", description: "Includes 1 Scent Diffuser + 1 Fragrance Bottle (500ml). Adjustable timer for steady scenting; each bottle lasts up to 2 months. Available in Urban Luxe & Oriental Sanctuary (custom scents upon request)."},
      { name: "Refill Pack", price: 120, img: "../image/refill.png", description: "500ml refill bottle lasting up to 2 months. Available in Urban Luxe & Oriental Sanctuary (customisable)."},
      { name: "6 Month Subscription Scent Diffuser Set", price: 388, img: "../image/scent.png", description: "Includes 1 Scent Diffuser + 3 Refill Bottles (500ml each). Refills delivered monthly or bi-monthly; each lasts up to 2 months. Choose from Urban Luxe & Oriental Sanctuary, customisable upon request."},
      { name: "Radiant Lamp Set", price: 99.90, img: "../image/lamp.png", description: "Includes 1 Radiant Lamp + 1 Scented Candle. Elegant flame-free lamp that melts candles safely and beautifully, adding a sense of ritual to your space. Adjustable brightness with 2 spare bulbs for long-lasting use."}    
    ],
    "Accessories": [
      { name: "Low Kitchen Cabinet include Thick Quartz Stone and Kitchen Sink per ft",img: "../image/curtain.png", price: 820 },
      { name: "Kitchen Yard Cabinet(Including Quartz Stone, Aluminium Gas Cylinder Roller Slide & Gas Hob)" ,img: "../image/curtain.png", price: 4600 },
      { name: "Customize Wardrobe (Melamine Finish) 2400mm Height per ft",img: "../image/curtain.png", price: 860},
      { name: "Customize Wardrobe (Melamine Finish) Full Height per ft",img: "../image/curtain.png", price: 980},
      { name: "Customize Wardrobe (Melamine Finish) 2400mm Height per ft",img: "../image/curtain.png", price: 980},
      { name: "Customize Wardrobe (Melamine Finish) Full Height per ft",img: "../image/curtain.png", price: 1200},
      { name: "Kitchen Wall Cabinet 700mm height per ft",img: "../image/curtain.png", price: 400},
      { name: "Kitchen Wall Cabinet 701-900mm height per ft",img: "../image/curtain.png", price: 500},
      { name: "Kitchen Wall Cabinet 901-1200mm height per ft",img: "../image/curtain.png", price: 640},
      { name: "Kitchen Wall Cabinet 1201-1500mm height per ft",img: "../image/curtain.png", price: 740},
      { name: "Kitchen Sliding Door per sq ft",img: "../image/curtain.png", price: 70},
      { name: "Customize Shoe Cabinet 900mm height per ft ",img: "../image/curtain.png", price: 400},  
      { name: "Customize Shoe Cabinet Full height per ft ",img: "../image/curtain.png", price: 920}, 
      { name: "Kitchen Island per ft ",img: "../image/island.jpeg", price: 980}, 
      { name: "TV console per ft ",img: "../image/curtain.png", price: 415},
      { name: "TV Background per ft ",img: "../image/tvbackground.jpeg", price: 45},
      { name: "Opened Wall Cupboard per ft 1200mm Height",img: "../image/curtain.png", price: 750},
      { name: "Closed Wall Cupboard per ft 1200mm Height",img: "../image/curtain.png", price: 640},
      { name: "Single-Sided Vestibule（玄关）per sq ft",img: "../image/curtain.png", price: 60},
      { name: "Double-Sided Vestibule（玄关）per sq ft",img: "../image/curtain.png", price: 95},
      { name: "Normal Study Table and Chair",img: "../image/curtain.png", price: 980},
      { name: "Egornable Study Table and Chair",img: "../image/curtain.png", price: 1800},
      ...
      { name: "Yard Window per sq ft",img: "../image/curtain.png", price: 65 },
      { name: "Door Grill",img: "../image/curtain.png", price: 2100 },
      { name: "Shower Screen",img: "../image/curtain.png", price: 580 },
      { name: "Leveling and Tiles",img: "../image/curtain.png", price: 1800},
      { name: "Kitchen to Yard Wall Hacking",img: "../image/hacking.jpg", price: 1500},
      { name: "Decorative Mirror for Toilets", price: 120, img: "../image/mirror.png" },
    ...
    "Plaster Ceiling": [
      //Type A
      { name: "Living Area", price: 1104, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1380, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1080, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 1020, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      //Type B
      { name: "Living Area", price: 2760, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1344, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1896, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 1140, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      //Type C
      { name: "Living Area", price: 1500, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1476, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1692, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 1200, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Study Area", price: 1152, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      //Type D1
      { name: "Living Area", price: 1920, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 2580, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1800, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 1392, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 1128, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      //Type D2
      { name: "Living Area", price: 1920, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 2580, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1800, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 1392, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 1128, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      //Type E
      { name: "Living Area", price: 1380, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 2496, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1944, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 1200, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 1116, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Study Area", price: 1440, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      //Type F
      { name: "Living Area", price: 1200, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1740, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1080, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 996, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 1032, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Family Living", price: 1020, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Closet", price: 1032, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Staircase", price: 912, allowedUnits: ["Type F"], img: "../image/plaster.png" },
    ]
  };
