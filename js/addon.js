...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const groupedAddons = {
    ...
    "Plaster Ceiling": [
      //Type A
      { name: "Living Area", price: 644, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 805, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 630, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 595, allowedUnits: ["Type A"], img: "../image/plaster.png" },
      //Type B
      { name: "Living Area", price: 1610, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 784, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1106, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 665, allowedUnits: ["Type B"], img: "../image/plaster.png" },
      //Type C
      { name: "Living Area", price: 875, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 861, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 987, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 700, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      { name: "Study Area", price: 672, allowedUnits: ["Type C"], img: "../image/plaster.png" },
      //Type D1
      { name: "Living Area", price: 1120, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1505, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1050, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 812, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 658, allowedUnits: ["Type D1"], img: "../image/plaster.png" },
      //Type D2
      { name: "Living Area", price: 1120, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1505, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1050, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 812, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 658, allowedUnits: ["Type D2"], img: "../image/plaster.png" },
      //Type E
      { name: "Living Area", price: 805, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Dining Area", price: 1456, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 1134, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 700, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 651, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      { name: "Study Area", price: 840, allowedUnits: ["Type E"], img: "../image/plaster.png" },
      //Type F
      { name: "Living Area", price: 700, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Dining Area", price:1015, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Master Bedroom", price: 630, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Bedroom 2", price: 581, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Bedroom 3", price: 602, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Family Living", price: 595, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Closet", price: 602, allowedUnits: ["Type F"], img: "../image/plaster.png" },
      { name: "Staircase", price: 532, allowedUnits: ["Type F"], img: "../image/plaster.png" },
    ]
  };
